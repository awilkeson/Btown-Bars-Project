...
class kokVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //        self.tableView.register(kokCell.self, forCellReuseIdentifier: "kokCell")
    ...
    func grabspecials() {
        ...
        let url = URL(string: "http://cgi.sice.indiana.edu/~team68/kokspecials.php")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: kokCell = self.tableView.dequeueReusableCell(withIdentifier: "kokCell") as! kokCell
