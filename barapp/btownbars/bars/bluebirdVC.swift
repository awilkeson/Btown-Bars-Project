...
class bluebirdVC: UIViewController , UITableViewDataSource, UITableViewDelegate {
...
//        var tempsat: [Special] = []
        ...
        let url = URL(string: "http://cgi.sice.indiana.edu/~team68/bluebirdspecials.php")
...
//            indexPath.section == 5 ? sattemp[indexPath.row] :
        ...
        let cell: bluebirdCell = self.tableView.dequeueReusableCell(withIdentifier: "bluebirdCell") as! bluebirdCell
