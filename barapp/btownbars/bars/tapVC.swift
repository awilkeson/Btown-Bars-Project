...
class tapVC: UIViewController , UITableViewDataSource, UITableViewDelegate {
    ...
    func grabspecials() {
        ...
        let url = URL(string: "http://cgi.sice.indiana.edu/~team68/bearsspecials.php")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: tapCell = self.tableView.dequeueReusableCell(withIdentifier: "tapCell") as! tapCell
