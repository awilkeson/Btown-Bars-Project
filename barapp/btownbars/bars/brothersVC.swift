...
class brothersVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
//        self.tableView.register(brothersCell.self, forCellReuseIdentifier: "brothersCell")
    ...
    func grabspecials() {
        ...
        let url = URL(string: "http://cgi.sice.indiana.edu/~team68/brothersspecials.php")
...
//        print("tyring to open and close")
//
...
//        let newspecial = montemp[indexPath.row]
        ...
        let cell: brothersCell = self.tableView.dequeueReusableCell(withIdentifier: "brothersCell") as! brothersCell
