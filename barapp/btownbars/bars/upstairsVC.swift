...
class upstairsVC: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    func grabspecials() {
        ...
        let url = URL(string: "http://cgi.sice.indiana.edu/~team68/upstairsspecials.php")
...
//            indexPath.section == 5 ? sattemp[indexPath.row] :
        ...
        let cell: upstairsCell = self.tableView.dequeueReusableCell(withIdentifier: "upstairsCell") as! upstairsCell
