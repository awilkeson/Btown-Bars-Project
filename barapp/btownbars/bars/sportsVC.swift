...
class sportsVC: UIViewController , UITableViewDataSource, UITableViewDelegate {
    ...
    func grabspecials() {
        ...
        let url = URL(string: "http://cgi.sice.indiana.edu/~team68/sportsspecials.php")
...
//            return tuestemp.count }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let newspecial =
//            indexPath.section == 0 ? montemp[indexPath.row] :
//            indexPath.section == 1 ? tuestemp[indexPath.row] :
            indexPath.section == 0 ? wedtemp[indexPath.row] :
            indexPath.section == 1 ? thurtemp[indexPath.row] :
            indexPath.section == 2 ? fritemp[indexPath.row] :
            indexPath.section == 3 ? sattemp[indexPath.row] :
            montemp[indexPath.row]
        
        let cell: sportsCell = self.tableView.dequeueReusableCell(withIdentifier: "sportsCell") as! sportsCell
